...
async def read_items(ds: List[str] = Query(default=["COVID20"])):
    #listOfTitle = ["name", "sym_all" ,"tongue", "pulse", "solution" , "herb_all", "note" ]  #選出要顯示的欄位
    listOfTitle = ["name", "description" , "solution" , "herb"]

    #ds = ["心悸","COVID19","COVID20","頭暈","口苦","眩暈","氣短","咳嗽"]  #測試用, 程式中用輸入的字串
    dft=pd.DataFrame(ds)
...
@app.get("/disease1_long/" , response_class=JSONResponse)
async def read_items(ds: List[str] = Query(default=["COVID20"])):
    ...
    listOfTitle1 = ["name", "sym_all" , "solution" , "herb_all" ]  #選出要顯示的欄位
...
async def read_items(ds: List[str] = Query(default=["COVID20"]), limit : int = 5):
#    listOfTitle2 = ["name", "sym_all" ,"tongue", "pulse", "solution" , "herb_all", "note" ]  #選出要顯示的欄位
    listOfTitle2 = ["name", "sym_all" ,"tongue", "pulse", "solution" , "herb_all", "note", "match_cnt", "match_ratio" ]  #選出要顯示的欄位
    #listOfTitle = ["name", "description" , "solution" , "herb"]
...
@app.get("/disease2_long/" , response_class=JSONResponse)
async def read_items(ds: List[str] = Query(default=["COVID20"])):
...
@app.get("/disease2h/" , response_class=HTMLResponse)
async def read_items(ds: List[str] = Query(default=["COVID20"]), limit : int = 5):
#    listOfTitle2 = ["name", "sym_all" ,"tongue", "pulse", "solution" , "herb_all", "note" ]  #選出要顯示的欄位
    listOfTitle2 = ["name", "sym_all" ,"tongue", "pulse", "solution" , "herb_all", "note", "match_cnt", "match_ratio" ]  #選出要顯示的欄位
    #listOfTitle = ["name", "description" , "solution" , "herb"]
...
async def read_item(request: Request, ptn_name: str):
    listOfTitle1 = ["name", "sym_all" , "solution" , "herb_all"]
